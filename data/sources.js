...
ZTZ_DATA.sources = [
  ...
  { id:"hatch",      name:"Hatch Outreach",          type:"Live bridge API", system:"ZTZ Bridge · /api/hatch",
    feeds:["Hatch ↔ CRM Reconciliation"], grain:"one row per Hatch contact",
    dataset:"hatch", status:"live" },
  { id:"angi",       name:"Angi Leads",              type:"Live bridge API", system:"ZTZ Bridge · /api/angi_leads",
    feeds:["Hatch ↔ CRM Reconciliation (Angi audit)"], grain:"one row per Angi lead",
    dataset:"angi_leads", status:"live" },
  { id:"bookings",   name:"Booked Jobs",             type:"Google Calendar + Slack", system:"Booked Jobs calendar (live in-browser) + #booking",
